...
public class Deck implements IDeck {
    ...
    public Deck() {
        ...
        cards[36] = new Card("Дама трефа", 10);
        cards[37] = new Card("Дама бубна", 10);
        cards[38] = new Card("Дама черви", 10);
        cards[39] = new Card("Дама пика", 10);

        cards[40] = new Card("Валет трефа", 10);
        cards[41] = new Card("Валет бубна", 10);
        cards[42] = new Card("Валет черви", 10);
        cards[43] = new Card("Валет пика", 10);
        ...
        cards[48] = new Card("Туз трефа", 10);
        cards[49] = new Card("Туз бубна", 10);
        cards[50] = new Card("Туз черви", 10);
        cards[51] = new Card("Туз пика", 10);
